from open_file_corr import times_dataframes_sobo, times_dataframes_mobo, times_dataframes_bofire
import pandas as pd
import numpy as np
...
average_times = [average_time_sobo, average_time_mobo, average_time_bofire]  
std_devs = [std_sobo, std_mobo, std_bofire] 
#std_devs = [0,0,0]
